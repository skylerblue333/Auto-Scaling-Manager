...
Custom auto-scaling logic based on application metrics.

## 🚀 Overview
This repository contains a professional implementation of **Auto Scaling Manager**. It is designed with clean code principles and focuses on functionality and reliability.
